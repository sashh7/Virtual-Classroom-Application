...
// Optional: a simple function to format ISO dates (customize as needed)
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <p className="italic text-gray-300">{assignment.instruction}</p>

                {/* Download link uses assignment.fileUrl */}
                {assignment.fileUrl && (
                  <a
                    href={`http://localhost:5001${assignment.fileUrl}`}
                    target="_blank"
                ...
                {/* Optionally: Show preview for uploaded file if available */}
                {assignment.submittedFiles &&
                  assignment.submittedFiles.length > 0 && (
                    <div className="mt-2">
                      <a
                        href={assignment.submittedFiles[0].fileUrl}
                        target="_blank"
                        rel="noopener noreferrer"
